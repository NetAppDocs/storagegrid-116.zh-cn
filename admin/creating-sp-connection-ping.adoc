...
* 您有 https://docs.pingidentity.com/pingfederate/13.1/administrators_reference_guide/pf_administrators_reference_guide.html["《管理员参考指南》"^] for PingFederate Server。PingFederate 文档提供了详细的分步说明和解释。
