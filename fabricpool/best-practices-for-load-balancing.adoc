...
虽然 StorageGRID 负载均衡器服务是推荐的负载均衡机制，但您可能需要集成第三方负载均衡器。有关信息，请联系您的 NetApp 客户代表或参阅 https://www.netapp.com/pdf.html?item=/media/17068-tr4626.pdf["TR-4626 ： StorageGRID 第三方和全局负载平衡器"^]。
